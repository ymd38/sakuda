...
const config = computed(() => buildDiffTrendConfig(props.history, resolveChartPalette()))
</script>

<template>
  <section>
    <h2 class="font-display text-heading-md text-mute uppercase">New / persisting / resolved</h2>
    <ClientOnly>
