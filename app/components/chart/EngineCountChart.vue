...
const config = computed(() => buildEngineCountConfig(props.history, resolveChartPalette()))
</script>

<template>
  <section>
    <h2 class="font-display text-heading-md text-mute uppercase">Findings by engine</h2>
    <ClientOnly>
